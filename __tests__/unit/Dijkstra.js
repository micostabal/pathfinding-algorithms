import { Dijkstra } from "../src/PathFindingAlgorithms/Dijkstra";
...
describe('Dijkstra\'s algorithm should work bug free', () => {
  ...
  it('should be able to compute easy path', () => {
    ...
    const dijkstraInstance = new Dijkstra(n, m, walls, origin, destination);
    
    const [wasFound, path] = dijkstraInstance.suiteExecution();
